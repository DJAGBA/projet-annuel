...
> ⏱️ **Temps d'exécution :** Environ 1 heure 45 minutes pour l'exécution complète (entraînement DCGAN + WGAN-GP, étude d'ablation sur seeds[42,123,7] et évaluation FID) sur un GPU T4 standard de Colab.
, 
---
